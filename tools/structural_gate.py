...
# Required graph
required=['client/pos_app/pubspec.yaml','client/pos_app/analysis_options.yaml','client/pos_app/lib/main.dart','client/pos_app/lib/app/app.dart','client/pos_app/lib/app/router.dart','client/pos_app/lib/database/app_database.dart','client/pos_app/lib/database/schema_v1.dart','client/pos_app/lib/database/schema_v2.dart','client/pos_app/lib/database/schema_v3.dart','client/pos_app/lib/database/schema_v6.dart','client/pos_app/lib/features/payments/domain/sale_payment.dart','client/pos_app/lib/sync/sync_repository.dart','client/pos_app/lib/sync/sync_service.dart','server/Pos.Server.sln','server/src/Api/Api.csproj','server/src/Application/Application.csproj','server/src/Domain/Domain.csproj','server/src/Infrastructure/Infrastructure.csproj','server/tests/Infrastructure.Tests/Infrastructure.Tests.csproj','server/src/Api/Program.cs','server/src/Application/Contracts.cs','server/src/Application/Abstractions.cs','server/src/Application/ReadAuthorization.cs','server/src/Domain/Entities.cs','server/src/Infrastructure/PosDbContext.cs','server/src/Infrastructure/SyncService.cs','server/src/Infrastructure/DeviceEnrollmentService.cs','server/src/Infrastructure/TenantReadService.cs','server/src/Infrastructure/RemoteReportService.cs','server/src/Infrastructure/JwtTokenService.cs','server/src/Application/ReportContracts.cs','client/pos_app/lib/features/cloud_admin/reports/data/remote_report_models.dart','client/pos_app/lib/features/cloud_admin/reports/data/remote_report_repository.dart','client/pos_app/lib/features/cloud_admin/reports/presentation/remote_reports_screen.dart','client/pos_app/lib/features/cloud_admin/reports/presentation/remote_report_detail_screen.dart']
...
required_entities=['Business','Branch','Device','UserAccount','Category','Supplier','Product','Purchase','PurchaseLine','InventoryLot','InventoryMovement','Sale','SaleLine','SaleLotAllocation','SalePayment','CashSession','Expense','InboundOperation','SyncChange','RefreshToken','DeviceEnrollmentToken']
