final class SyncPullChange {
  ...
  factory SyncPullChange.fromJson(Map<String, Object?> j) => SyncPullChange(
    cursor: (j['cursor'] as num).toInt(),
    entityType: j['entityType'] as String,
    entityGlobalId: j['entityGlobalId'] as String,
    operation: j['operation'] as String,
    version: (j['version'] as num).toInt(),
    changedAt: DateTime.parse(j['changedAt'] as String).toUtc(),
...
final class SyncPullBatch {
  ...
  factory SyncPullBatch.fromJson(Map<String, Object?> j) => SyncPullBatch(
    nextCursor: (j['nextCursor'] as num).toInt(),
    hasMore: j['hasMore'] as bool,
    changes: (j['changes'] as List)
        .map(
          (e) => SyncPullChange.fromJson(Map<String, Object?>.from(e as Map)),
        )
        .toList(),
    serverTime: DateTime.parse(j['serverTime'] as String).toUtc(),
  );
}
