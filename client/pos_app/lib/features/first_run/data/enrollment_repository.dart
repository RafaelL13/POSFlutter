...
final class EnrollmentRepository {
  ...
  Future<void> redeem({
    ...
    final deviceGid = await stableDeviceGlobalId();
    ...
    final auth = Map<String, Object?>.from(j['auth'] as Map);
    await _tokens.save(
    ...
    await db.transaction((tx) async {
      ...
      final business = Map<String, Object?>.from(j['business'] as Map);
      final branch = Map<String, Object?>.from(j['branch'] as Map);
      final device = Map<String, Object?>.from(j['device'] as Map);
      final user = Map<String, Object?>.from(j['user'] as Map);
      ...
      await tx.insert('users', {
        ...
        'password_hash': 'REMOTE_ONLY',
        'password_salt': 'REMOTE_ONLY',
        'role': user['role'],
