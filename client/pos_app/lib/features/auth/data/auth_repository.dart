...
final class LocalAuthSession {
  const LocalAuthSession(this.userGlobalId, this.role);
...
final class AuthRepository {
  ...
  Future<LocalAuthSession?> login(String username, String password) async {
    ...
    final r = rows.first;
    if (!await _hasher.verify(
      password,
      r['password_hash'] as String,
      r['password_salt'] as String,
    )) {
      return null;
    }
    ...
    return LocalAuthSession(r['global_id'] as String, r['role'] as String);
  }
